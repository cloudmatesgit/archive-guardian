...
import { HardDrive, Lock, Mail, Eye, EyeOff } from 'lucide-react';
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 flex items-center justify-center p-4">
      ...
      <Card className="w-full max-w-md relative z-10 bg-card/95 backdrop-blur border-border/50">
        <CardHeader className="text-center pb-2">
          ...
          <CardTitle className="text-2xl font-bold">TierVault</CardTitle>
          <CardDescription>Enterprise Storage Management Platform</CardDescription>
        </CardHeader>
        <CardContent>
